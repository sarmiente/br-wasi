...
var _a;
const $$Comprar = createComponent(async ($$result, $$props, $$slots) => {
  changeLanguage("es");
...
</script>`])), renderComponent($$result, "Layout", $$Layout, { "title": "Propiedades en Venta" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section id="properties" class="py-12 pt-32"> <!-- Título del portafolio --> <h2 class="text-center text-xl md:text-3xl font-heading uppercase pt-10 pb-10">
...
}, "C:/Users/User.DESKTOP-H22LPQ4/Desktop/DEVs/brsolution-api/src/pages/comprar.astro", void 0);
const $$file = "C:/Users/User.DESKTOP-H22LPQ4/Desktop/DEVs/brsolution-api/src/pages/comprar.astro";
const $$url = "/comprar";
