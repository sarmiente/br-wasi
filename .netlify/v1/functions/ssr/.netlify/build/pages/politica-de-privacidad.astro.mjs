...
const $$PoliticaDePrivacidad = createComponent(($$result, $$props, $$slots) => {
  changeLanguage("es");
  return renderTemplate`${maybeRenderHead()}<h1><strong>Privacy Policy</strong></h1>
This Privacy Policy describes how your personal information is collected, used, and shared when you visit https://brsolution.com.co/ (the "Site").
...
<ul> <li>Communicate with you;</li> <li>Screen our orders for potential risk or fraud; and</li> <li>When in line with the preferences you have shared with us, provide you with information or advertising relating to our products or services.</li> </ul>
We use the Device Information that we collect to help us screen for potential risk and fraud (in particular, your IP address), and more generally to improve and optimize our Site (for example, by generating analytics about how our customers browse and interact with the Site, and to assess the success of our marketing and advertising campaigns).
<h2><strong>SHARING YOUR PERSONAL INFORMATION</strong></h2>
We share your Personal Information with third parties to help us use your Personal Information, as described above. For example, we use Shopify to power our online store--you can read more about how Shopify uses your Personal Information here: <a target="_new" rel="noopener">https://www.shopify.com/legal/privacy</a>. We also use Google Analytics to help us understand how our customers use the Site -- you can read more about how Google uses your Personal Information here: <a href="https://www.google.com/intl/en/policies/privacy/" target="_new" rel="noopener">https://www.google.com/intl/en/policies/privacy/</a>. You can also opt out of Google Analytics here: <a href="https://tools.google.com/dlpage/gaoptout" target="_new" rel="noopener">https://tools.google.com/dlpage/gaoptout</a>.
...
<h2>Cookies</h2>
Cookies can be used to control when the WhatsApp floating button chat window should be automatically displayed. These cookies ("joinchat_views", "joinchat_hashes") do not contain personal data, are of type HTML LocalStorage and do not expire.
<h3>Plugin: Smush</h3>
...
<em><strong>info@brsolution.com.co</strong></em>`;
}, "C:/Users/User.DESKTOP-H22LPQ4/Desktop/DEVs/brsolution-api/src/pages/politica-de-privacidad.astro", void 0);

const $$file = "C:/Users/User.DESKTOP-H22LPQ4/Desktop/DEVs/brsolution-api/src/pages/politica-de-privacidad.astro";
