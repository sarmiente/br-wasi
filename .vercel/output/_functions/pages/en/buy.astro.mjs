...
const $$Buy = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const res = await fetch(`${urlSearch}id_company=${"23639330"}&wasi_token=${"6Blp_oUrv_kl9r_m0rE"}&take=100&for_sale=true`, options);
...
}, "C:/Users/User.DESKTOP-H22LPQ4/Desktop/DEVs/brsolution-api/src/pages/en/buy.astro", void 0);
const $$file = "C:/Users/User.DESKTOP-H22LPQ4/Desktop/DEVs/brsolution-api/src/pages/en/buy.astro";
const $$url = "/en/buy";
